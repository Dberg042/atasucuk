...
export const resultByProblem: Record<string, Loc> = {
  price: {
    no: 'Du er ikke alene — de fleste på listen sier det samme. Derfor lager vi ekte sucuk her hjemme, uten toll og mellomledd — til en rettferdig pris.',
    tr: 'Yalnız değilsin — listedekilerin çoğu da aynı şeyi söylüyor. Tam da bu yüzden burada, gümrüksüz ve aracısız üretiyoruz: adil bir fiyata.',
    en: 'You’re not alone — most people on the list say the same. That’s why we make real sucuk here at home, without customs and middlemen — at a fair price.',
  },
  additives: {
  ...
  trust: {
    ...
    tr: 'Bu yüzden her şeyi açık açık, seninle birlikte yapıyoruz — içindekileri de süreci de görüyorsun.',
...
export const surveyUI: Record<string, SurveyUI> = {
  no: {
    ...
    reg_phone_ph: '+47 …',
    reg_phone_hint: 'Vinner du, ringer vi deg — og i Agder avtaler vi levering på dette nummeret.',
    reg_consent:
  ...
  en: {
    ...
    reg_phone_ph: '+47 …',
    reg_phone_hint: 'If you win, we call you — and in Agder we arrange delivery on this number.',
    reg_consent:
...
export const shareUI: Record<string, ShareUI> = {
  ...
  tr: {
    title: 'Bir arkadaşını davet et — ikiniz de kazanın.',
